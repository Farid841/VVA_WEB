...
<body class="w3-content w3-border-left w3-border-right">
    ...
    <nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px" id="mySidebar">
        <div class="w3-container w3-display-container w3-padding-16">
            ...
            <form action="/action_page.php" target="_blank">
                ...
                <p><label><i class="fa fa-calendar-o"></i> Type</label></p>
    ...
    <div class="w3-main w3-white" style="margin-left:260px">
        ...
        <div class="w3-bar w3-white w3-large">
            <a href="index.php" class="w3-bar-item w3-button w3-red w3-mobile"><i class="fa fa-bed w3-margin-right"></i>Logo</a>
        ...
        <div class="w3-container" id="apartment">
            <h2 class="w3-text-red">The Apartment</h2>
            <div class="w3-display-container mySlides">
                <img src="uploads/1789654123.jpg" style="width:100%;margin-bottom:-6px">
        ...
        <div class="w3-row-padding w3-section">
            <div class="w3-col s3">
                <img class="demo w3-opacity w3-hover-opacity-off" src="uploads/1789654123.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(1)" title="Living room">
            </div>
            <div class="w3-col s3">
                <img class="demo w3-opacity w3-hover-opacity-off" src="uploads/1789654123.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(2)" title="Dining room">
            </div>
            <div class="w3-col s3">
                <img class="demo w3-opacity w3-hover-opacity-off" src="uploads/1789654123.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(3)" title="Bedroom">
            </div>
            <div class="w3-col s3">
                <img class="demo w3-opacity w3-hover-opacity-off" src="uploads/1789654123.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(4)" title="Second Living Room">
            </div>
        </div>
